...
public class CodingProblems {
	...
	private static void firstLastIndex() {
		Scanner sc = new Scanner(System.in);
		int n = sc.nextInt();
		int arr[] = new int[n];
		...
		System.out.println(first_last("first", arr, data));
		System.out.println(first_last("last", arr, data));

	}

	private static int first_last(String str, int[] arr, int data) {
		int low = 0, high = arr.length - 1, key = -1;
